...
class AGC:
    ...
    def run(self):
        ...
        generacion = 0
        archivo = open("quartic_" + str(self._ejecucion)+"_16.txt", "w")
        while generacion < self._generaciones:
            ...
            valor =  -1 * (self._mejor_historico._fitness - (self._problema.MAX_VALUE * 1000 * self._alelos))
    ...
    def evaluaIndividuos(self):
        for i in self._individuos:
            ...
            i._fitness *= -1
            i._fitness += self._problema.MAX_VALUE * 1000 * self._alelos 
